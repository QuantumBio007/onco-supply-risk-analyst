...
- Plan B (INVIMA retrospective lead-time): **COMPLETE 2026-05-06 (extended window update same day).** Extended window: 9 → 11 snapshots (added 2022-12 cuatrimestral + 2023-04 monthly). Verdicts: H1 NULL (confirmed dual cause — window truncation AND product-name canonicalization discontinuity; cannot resolve with more historical PDFs alone), **H2 PASS (openFDA leads INVIMA by median 118 days; carboplatin 217d [load-bearing], methotrexate 19d [marginal])**, H3 PASS (3/3 observable, 1 LT — cleaner than original). Defensible claim: "Cross-database surveillance gives 19–217 days of leading signal; carboplatin case is the anchor at 7 months." Cannot claim live news pipeline predicts shortages. See [phase2_realtime/docs/t3_1b_results_2026-05-06.md](phase2_realtime/docs/t3_1b_results_2026-05-06.md). Next: H4 pre-registration for INN-level monitorizacion → desabastecido hypothesis.
